        ...
        <Carousel>
          <CarouselContent>
            {categories.map((category) => (
              <CarouselItem className="basis-1/2 md:basis-1/3 lg:basis-1/6" key={category._id}>
                <div className="flex flex-col self-center rounded-lg bg-linear-to-r from-[#F1F1F1] to-[#F7F7F7] w-full aspect-square justify-center items-center">
                  <Image src={getImageUrl(category.imageUrl)} width={86} height="86" alt={category.name} className="mb-2.5 w-20" />
