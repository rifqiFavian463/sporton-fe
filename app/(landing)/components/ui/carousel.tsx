...
function CarouselPrevious({ className, variant = "primary", size = "normal", ...props }: React.ComponentProps<typeof Button>) {
...
function CarouselNext({ className, variant = "primary", size = "normal", ...props }: React.ComponentProps<typeof Button>) {
